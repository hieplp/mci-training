 ...
 * both are present, adds the sum and the collected {@link Step}s — or
 * the {@link IllegalArgumentException} message on invalid input — to
 * the model for the {@code index} view.</p>
 *
    ...
    public String index(
        ...
        if (stn1 != null && stn2 != null) {
            try {
                ...
                String sum = sumService.sum(stn1, stn2, steps::add);
